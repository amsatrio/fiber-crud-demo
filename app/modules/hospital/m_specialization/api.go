...
type MSpecializationHandler struct {
	service  MSpecializationService
	validate *validator.Validate
}

func NewMSpecializationHandler(service MSpecializationService, validate *validator.Validate) *MSpecializationHandler {
	return &MSpecializationHandler{
		service:  service,
		validate: validate,
	}
}

// MSpecializationCreate godoc
//
//	@Summary        MSpecializationCreate
//	@Description    Create MSpecialization
//	@Tags           mSpecialization
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mSpecialization   body        MSpecializationRequest    true    "Add MSpecializationRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-specialization [post]
func (h *MSpecializationHandler) MSpecializationCreate(c fiber.Ctx) error {

	res := &response.Response{}
	payload := new(MSpecializationRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MSpecializationCreate", "create data error: "+err.Error())
...
// MSpecializationUpdate godoc
//
//	@Summary        MSpecializationUpdate
//	@Description    Update MSpecialization
//	@Tags           mSpecialization
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mSpecialization   body        MSpecializationRequest    true    "Update MSpecializationRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-specialization [put]
func (h *MSpecializationHandler) MSpecializationUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MSpecializationUpdate", "update data error: "+err.Error())
...
// MSpecializationIndex godoc
//
//	@Summary        MSpecializationIndex
//	@Description    Get MSpecialization by id
//	@Tags           mSpecialization
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MSpecialization id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-specialization/{id} [get]
func (h *MSpecializationHandler) MSpecializationIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MSpecializationIndex", err.Error())
...
// MSpecializationDelete godoc
//
//	@Summary        MSpecializationDelete
//	@Description    Delete MSpecialization by id
//	@Tags           mSpecialization
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-specialization/{id} [delete]
func (h *MSpecializationHandler) MSpecializationDelete(c fiber.Ctx) error {
	res := &response.Response{}
...
// MSpecializationPage godoc
//
//	@Summary        MSpecializationPage
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-specialization [get]
func (h *MSpecializationHandler) MSpecializationPage(c fiber.Ctx) error {
	res := &response.Response{}
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "MSpecializationPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MSpecializationPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
