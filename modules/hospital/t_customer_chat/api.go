...
type TCustomerChatHandler struct {
    service  TCustomerChatService
    validate *validator.Validate
}

func NewTCustomerChatHandler(service TCustomerChatService, validate *validator.Validate) *TCustomerChatHandler {
    return &TCustomerChatHandler{
        service:  service,
        validate: validate,
    }
}

// TCustomerChatCreate godoc
//
//  @Summary        TCustomerChatCreate
//  @Description    Create TCustomerChat
//  @Tags           tCustomerChat
//  @Accept         json
//  @Produce        json
//  @Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//  @Param          tCustomerChat   body        TCustomerChatRequest    true    "Add TCustomerChatRequest"
...
func (h *TCustomerChatHandler) TCustomerChatCreate(c fiber.Ctx) error {
    ...
    payload := new(TCustomerChatRequest)
    ...
    if err != nil {
        util.Log("ERROR", "controllers", "TCustomerChatCreate", "create data error: "+err.Error())
...
// TCustomerChatUpdate godoc
//
//  @Summary        TCustomerChatUpdate
//  @Description    Update TCustomerChat
//  @Tags           tCustomerChat
//  @Accept         json
//  @Produce        json
//  @Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//  @Param          tCustomerChat   body        TCustomerChatRequest    true    "Update TCustomerChatRequest"
//  @Success        200 {object}    response.Response
//  @Failure        400 {object}    response.Response
//  @Failure        404 {object}    response.Response
//  @Failure        500 {object}    response.Response
...
func (h *TCustomerChatHandler) TCustomerChatUpdate(c fiber.Ctx) error {
    ...
    if err != nil {
        util.Log("ERROR", "controllers", "TCustomerChatUpdate", "update data error: "+err.Error())
...
// TCustomerChatIndex godoc
//
//  @Summary        TCustomerChatIndex
//  @Description    Get TCustomerChat by id
//  @Tags           tCustomerChat
//  @Accept         json
//  @Produce        json
//  @Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//  @Param          id  path        int true    "TCustomerChat id"
//  @Success        200 {object}    response.Response
//  @Failure        400 {object}    response.Response
//  @Failure        404 {object}    response.Response
//  @Failure        500 {object}    response.Response
...
func (h *TCustomerChatHandler) TCustomerChatIndex(c fiber.Ctx) error {
    ...
    if err != nil {
        util.Log("ERROR", "controllers", "TCustomerChatIndex", err.Error())
...
// TCustomerChatDelete godoc
//
//  @Summary        TCustomerChatDelete
//  @Description    Delete TCustomerChat by id
//  @Tags           tCustomerChat
//  @Accept         json
//  @Produce        json
//  @Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
// TCustomerChatPage godoc
//
//  @Summary        TCustomerChatPage
...
func (h *TCustomerChatHandler) TCustomerChatPage(c fiber.Ctx) error {
    ...
    if jsonUnmarshalErr != nil {
        util.Log("ERROR", "controllers", "TCustomerChatPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
    ...
    if err != nil {
        util.Log("ERROR", "controllers", "TCustomerChatPage", "error: "+err.Error())
        res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
        return c.Status(res.Status).JSON(res)
    }
