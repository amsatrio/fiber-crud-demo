...
type MWalletDefaultNominalHandler struct {
	service  MWalletDefaultNominalService
	validate *validator.Validate
}

func NewMWalletDefaultNominalHandler(service MWalletDefaultNominalService, validate *validator.Validate) *MWalletDefaultNominalHandler {
	return &MWalletDefaultNominalHandler{
		service:  service,
		validate: validate,
	}
}

// MWalletDefaultNominalCreate godoc
//
//	@Summary        MWalletDefaultNominalCreate
//	@Description    Create MWalletDefaultNominal
//	@Tags           mWalletDefaultNominal
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mWalletDefaultNominal   body        MWalletDefaultNominalRequest    true    "Add MWalletDefaultNominalRequest"
...
func (h *MWalletDefaultNominalHandler) MWalletDefaultNominalCreate(c fiber.Ctx) error {
	...
	payload := new(MWalletDefaultNominalRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MWalletDefaultNominalCreate", "create data error: "+err.Error())
...
// MWalletDefaultNominalUpdate godoc
//
//	@Summary        MWalletDefaultNominalUpdate
//	@Description    Update MWalletDefaultNominal
//	@Tags           mWalletDefaultNominal
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mWalletDefaultNominal   body        MWalletDefaultNominalRequest    true    "Update MWalletDefaultNominalRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *MWalletDefaultNominalHandler) MWalletDefaultNominalUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MWalletDefaultNominalUpdate", "update data error: "+err.Error())
...
// MWalletDefaultNominalIndex godoc
//
//	@Summary        MWalletDefaultNominalIndex
//	@Description    Get MWalletDefaultNominal by id
//	@Tags           mWalletDefaultNominal
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MWalletDefaultNominal id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *MWalletDefaultNominalHandler) MWalletDefaultNominalIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MWalletDefaultNominalIndex", err.Error())
...
// MWalletDefaultNominalDelete godoc
//
//	@Summary        MWalletDefaultNominalDelete
//	@Description    Delete MWalletDefaultNominal by id
//	@Tags           mWalletDefaultNominal
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
// MWalletDefaultNominalPage godoc
//
//	@Summary        MWalletDefaultNominalPage
...
func (h *MWalletDefaultNominalHandler) MWalletDefaultNominalPage(c fiber.Ctx) error {
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "MWalletDefaultNominalPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MWalletDefaultNominalPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
