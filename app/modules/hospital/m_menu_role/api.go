...
type MMenuRoleHandler struct {
	service  MMenuRoleService
	validate *validator.Validate
}

func NewMMenuRoleHandler(service MMenuRoleService, validate *validator.Validate) *MMenuRoleHandler {
	return &MMenuRoleHandler{
		service:  service,
		validate: validate,
	}
}

// MMenuRoleCreate godoc
//
//	@Summary        MMenuRoleCreate
//	@Description    Create MMenuRole
//	@Tags           mMenuRole
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mMenuRole   body        MMenuRoleRequest    true    "Add MMenuRoleRequest"
...
func (h *MMenuRoleHandler) MMenuRoleCreate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMenuRoleCreate", "create data error: "+err.Error())
...
// MMenuRoleUpdate godoc
//
//	@Summary        MMenuRoleUpdate
//	@Description    Update MMenuRole
//	@Tags           mMenuRole
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mMenuRole   body        MMenuRoleRequest    true    "Update MMenuRoleRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *MMenuRoleHandler) MMenuRoleUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMenuRoleUpdate", "update data error: "+err.Error())
...
// MMenuRoleIndex godoc
//
//	@Summary        MMenuRoleIndex
//	@Description    Get MMenuRole by id
//	@Tags           mMenuRole
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MMenuRole id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *MMenuRoleHandler) MMenuRoleIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMenuRoleIndex", err.Error())
...
// MMenuRoleDelete godoc
//
//	@Summary        MMenuRoleDelete
//	@Description    Delete MMenuRole by id
//	@Tags           mMenuRole
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
func (h *MMenuRoleHandler) MMenuRolePage(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMenuRolePage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
