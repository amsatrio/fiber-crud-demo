...
//  @Router         /v1/t-customer-wallet-top-up [post]
...
//  @Failure        404 {object}    response.Response
//  @Failure        500 {object}    response.Response
//  @Router         /v1/t-customer-wallet-top-up [put]
...
//  @Failure        404 {object}    response.Response
//  @Failure        500 {object}    response.Response
//  @Router         /v1/t-customer-wallet-top-up/{id} [get]
...
//  @Failure        404 {object}    response.Response
//  @Failure        500 {object}    response.Response
//  @Router         /v1/t-customer-wallet-top-up/{id} [delete]
...
//  @Failure        404 {object}    response.Response
//  @Failure        500 {object}    response.Response
//  @Router         /v1/t-customer-wallet-top-up [get]
