...
type TMedicalItemPurchaseHandler struct {
	service  TMedicalItemPurchaseService
	validate *validator.Validate
}

func NewTMedicalItemPurchaseHandler(service TMedicalItemPurchaseService, validate *validator.Validate) *TMedicalItemPurchaseHandler {
	return &TMedicalItemPurchaseHandler{
		service:  service,
		validate: validate,
	}
}

// TMedicalItemPurchaseCreate godoc
//
//	@Summary        TMedicalItemPurchaseCreate
//	@Description    Create TMedicalItemPurchase
//	@Tags           tMedicalItemPurchase
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tMedicalItemPurchase   body        TMedicalItemPurchaseRequest    true    "Add TMedicalItemPurchaseRequest"
...
func (h *TMedicalItemPurchaseHandler) TMedicalItemPurchaseCreate(c fiber.Ctx) error {
	...
	payload := new(TMedicalItemPurchaseRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TMedicalItemPurchaseCreate", "create data error: "+err.Error())
...
// TMedicalItemPurchaseUpdate godoc
//
//	@Summary        TMedicalItemPurchaseUpdate
//	@Description    Update TMedicalItemPurchase
//	@Tags           tMedicalItemPurchase
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tMedicalItemPurchase   body        TMedicalItemPurchaseRequest    true    "Update TMedicalItemPurchaseRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *TMedicalItemPurchaseHandler) TMedicalItemPurchaseUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TMedicalItemPurchaseUpdate", "update data error: "+err.Error())
...
// TMedicalItemPurchaseIndex godoc
//
//	@Summary        TMedicalItemPurchaseIndex
//	@Description    Get TMedicalItemPurchase by id
//	@Tags           tMedicalItemPurchase
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "TMedicalItemPurchase id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *TMedicalItemPurchaseHandler) TMedicalItemPurchaseIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TMedicalItemPurchaseIndex", err.Error())
...
// TMedicalItemPurchaseDelete godoc
//
//	@Summary        TMedicalItemPurchaseDelete
//	@Description    Delete TMedicalItemPurchase by id
//	@Tags           tMedicalItemPurchase
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
// TMedicalItemPurchasePage godoc
//
//	@Summary        TMedicalItemPurchasePage
...
func (h *TMedicalItemPurchaseHandler) TMedicalItemPurchasePage(c fiber.Ctx) error {
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "TMedicalItemPurchasePage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TMedicalItemPurchasePage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
