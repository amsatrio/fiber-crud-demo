...
type MMedicalFacilityHandler struct {
    service  MMedicalFacilityService
    validate *validator.Validate
}

func NewMMedicalFacilityHandler(service MMedicalFacilityService, validate *validator.Validate) *MMedicalFacilityHandler {
    return &MMedicalFacilityHandler{
        service:  service,
        validate: validate,
    }
}

// MMedicalFacilityCreate godoc
//
//  @Summary        MMedicalFacilityCreate
//  @Description    Create MMedicalFacility
//  @Tags           mMedicalFacility
//  @Accept         json
//  @Produce        json
//  @Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//  @Param          mMedicalFacility   body        MMedicalFacilityRequest    true    "Add MMedicalFacilityRequest"
...
func (h *MMedicalFacilityHandler) MMedicalFacilityCreate(c fiber.Ctx) error {
    ...
    payload := new(MMedicalFacilityRequest)
    ...
    if err != nil {
        util.Log("ERROR", "controllers", "MMedicalFacilityCreate", "create data error: "+err.Error())
...
// MMedicalFacilityUpdate godoc
//
//  @Summary        MMedicalFacilityUpdate
//  @Description    Update MMedicalFacility
//  @Tags           mMedicalFacility
//  @Accept         json
//  @Produce        json
//  @Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//  @Param          mMedicalFacility   body        MMedicalFacilityRequest    true    "Update MMedicalFacilityRequest"
//  @Success        200 {object}    response.Response
//  @Failure        400 {object}    response.Response
//  @Failure        404 {object}    response.Response
//  @Failure        500 {object}    response.Response
...
func (h *MMedicalFacilityHandler) MMedicalFacilityUpdate(c fiber.Ctx) error {
    ...
    if err != nil {
        util.Log("ERROR", "controllers", "MMedicalFacilityUpdate", "update data error: "+err.Error())
...
// MMedicalFacilityIndex godoc
//
//  @Summary        MMedicalFacilityIndex
//  @Description    Get MMedicalFacility by id
//  @Tags           mMedicalFacility
//  @Accept         json
//  @Produce        json
//  @Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//  @Param          id  path        int true    "MMedicalFacility id"
//  @Success        200 {object}    response.Response
//  @Failure        400 {object}    response.Response
//  @Failure        404 {object}    response.Response
//  @Failure        500 {object}    response.Response
...
func (h *MMedicalFacilityHandler) MMedicalFacilityIndex(c fiber.Ctx) error {
    ...
    if err != nil {
        util.Log("ERROR", "controllers", "MMedicalFacilityIndex", err.Error())
...
// MMedicalFacilityDelete godoc
//
//  @Summary        MMedicalFacilityDelete
//  @Description    Delete MMedicalFacility by id
//  @Tags           mMedicalFacility
//  @Accept         json
//  @Produce        json
//  @Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
// MMedicalFacilityPage godoc
//
//  @Summary        MMedicalFacilityPage
...
func (h *MMedicalFacilityHandler) MMedicalFacilityPage(c fiber.Ctx) error {
    ...
    if jsonUnmarshalErr != nil {
        util.Log("ERROR", "controllers", "MMedicalFacilityPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
    ...
    if err != nil {
        util.Log("ERROR", "controllers", "MMedicalFacilityPage", "error: "+err.Error())
        res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
        return c.Status(res.Status).JSON(res)
    }
