...
type MLocationHandler struct {
	service  MLocationService
	validate *validator.Validate
}

func NewMLocationHandler(service MLocationService, validate *validator.Validate) *MLocationHandler {
...
// MLocationCreate godoc
//
//	@Summary        MLocationCreate
//	@Description    Create MLocation
//	@Tags           mLocation
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mLocation   body        MLocationRequest    true    "Add MLocationRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-location [post]
func (h *MLocationHandler) MLocationCreate(c fiber.Ctx) error {

	res := &response.Response{}
	payload := new(MLocationRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MLocationCreate", "create data error: "+err.Error())
...
// MLocationUpdate godoc
//
//	@Summary        MLocationUpdate
//	@Description    Update MLocation
//	@Tags           mLocation
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mLocation   body        MLocationRequest    true    "Update MLocationRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-location [put]
func (h *MLocationHandler) MLocationUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MLocationUpdate", "update data error: "+err.Error())
...
// MLocationIndex godoc
//
//	@Summary        MLocationIndex
//	@Description    Get MLocation by id
//	@Tags           mLocation
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MLocation id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-location/{id} [get]
func (h *MLocationHandler) MLocationIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MLocationIndex", err.Error())
...
// MLocationDelete godoc
//
//	@Summary        MLocationDelete
//	@Description    Delete MLocation by id
//	@Tags           mLocation
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-location/{id} [delete]
func (h *MLocationHandler) MLocationDelete(c fiber.Ctx) error {
	res := &response.Response{}
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-location [get]
func (h *MLocationHandler) MLocationPage(c fiber.Ctx) error {
	res := &response.Response{}
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "MLocationPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MLocationPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
