...
type TDoctorOfficeHandler struct {
	service  TDoctorOfficeService
	validate *validator.Validate
}

func NewTDoctorOfficeHandler(service TDoctorOfficeService, validate *validator.Validate) *TDoctorOfficeHandler {
	return &TDoctorOfficeHandler{
		service:  service,
		validate: validate,
	}
}

// TDoctorOfficeCreate godoc
//
//	@Summary        TDoctorOfficeCreate
//	@Description    Create TDoctorOffice
//	@Tags           tDoctorOffice
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tDoctorOffice   body        TDoctorOfficeRequest    true    "Add TDoctorOfficeRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-doctor-office [post]
func (h *TDoctorOfficeHandler) TDoctorOfficeCreate(c fiber.Ctx) error {

	res := &response.Response{}
	payload := new(TDoctorOfficeRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TDoctorOfficeCreate", "create data error: "+err.Error())
...
// TDoctorOfficeUpdate godoc
//
//	@Summary        TDoctorOfficeUpdate
//	@Description    Update TDoctorOffice
//	@Tags           tDoctorOffice
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tDoctorOffice   body        TDoctorOfficeRequest    true    "Update TDoctorOfficeRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-doctor-office [put]
func (h *TDoctorOfficeHandler) TDoctorOfficeUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TDoctorOfficeUpdate", "update data error: "+err.Error())
...
// TDoctorOfficeIndex godoc
//
//	@Summary        TDoctorOfficeIndex
//	@Description    Get TDoctorOffice by id
//	@Tags           tDoctorOffice
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "TDoctorOffice id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-doctor-office/{id} [get]
func (h *TDoctorOfficeHandler) TDoctorOfficeIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TDoctorOfficeIndex", err.Error())
...
// TDoctorOfficeDelete godoc
//
//	@Summary        TDoctorOfficeDelete
//	@Description    Delete TDoctorOffice by id
//	@Tags           tDoctorOffice
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-doctor-office/{id} [delete]
func (h *TDoctorOfficeHandler) TDoctorOfficeDelete(c fiber.Ctx) error {
	res := &response.Response{}
...
// TDoctorOfficePage godoc
//
//	@Summary        TDoctorOfficePage
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-doctor-office [get]
func (h *TDoctorOfficeHandler) TDoctorOfficePage(c fiber.Ctx) error {
	res := &response.Response{}
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "TDoctorOfficePage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TDoctorOfficePage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
