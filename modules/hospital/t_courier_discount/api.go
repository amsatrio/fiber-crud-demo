...
type TCourierDiscountHandler struct {
    service  TCourierDiscountService
    validate *validator.Validate
}

func NewTCourierDiscountHandler(service TCourierDiscountService, validate *validator.Validate) *TCourierDiscountHandler {
    return &TCourierDiscountHandler{
        service:  service,
        validate: validate,
    }
}

// TCourierDiscountCreate godoc
//
//  @Summary        TCourierDiscountCreate
//  @Description    Create TCourierDiscount
//  @Tags           tCourierDiscount
//  @Accept         json
//  @Produce        json
//  @Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//  @Param          tCourierDiscount   body        TCourierDiscountRequest    true    "Add TCourierDiscountRequest"
...
func (h *TCourierDiscountHandler) TCourierDiscountCreate(c fiber.Ctx) error {
    ...
    payload := new(TCourierDiscountRequest)
    ...
    if err != nil {
        util.Log("ERROR", "controllers", "TCourierDiscountCreate", "create data error: "+err.Error())
...
// TCourierDiscountUpdate godoc
//
//  @Summary        TCourierDiscountUpdate
//  @Description    Update TCourierDiscount
//  @Tags           tCourierDiscount
//  @Accept         json
//  @Produce        json
//  @Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//  @Param          tCourierDiscount   body        TCourierDiscountRequest    true    "Update TCourierDiscountRequest"
//  @Success        200 {object}    response.Response
//  @Failure        400 {object}    response.Response
//  @Failure        404 {object}    response.Response
//  @Failure        500 {object}    response.Response
...
func (h *TCourierDiscountHandler) TCourierDiscountUpdate(c fiber.Ctx) error {
    ...
    if err != nil {
        util.Log("ERROR", "controllers", "TCourierDiscountUpdate", "update data error: "+err.Error())
...
// TCourierDiscountIndex godoc
//
//  @Summary        TCourierDiscountIndex
//  @Description    Get TCourierDiscount by id
//  @Tags           tCourierDiscount
//  @Accept         json
//  @Produce        json
//  @Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//  @Param          id  path        int true    "TCourierDiscount id"
//  @Success        200 {object}    response.Response
//  @Failure        400 {object}    response.Response
//  @Failure        404 {object}    response.Response
//  @Failure        500 {object}    response.Response
...
func (h *TCourierDiscountHandler) TCourierDiscountIndex(c fiber.Ctx) error {
    ...
    if err != nil {
        util.Log("ERROR", "controllers", "TCourierDiscountIndex", err.Error())
...
// TCourierDiscountDelete godoc
//
//  @Summary        TCourierDiscountDelete
//  @Description    Delete TCourierDiscount by id
//  @Tags           tCourierDiscount
//  @Accept         json
//  @Produce        json
//  @Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
// TCourierDiscountPage godoc
//
//  @Summary        TCourierDiscountPage
...
func (h *TCourierDiscountHandler) TCourierDiscountPage(c fiber.Ctx) error {
    ...
    if jsonUnmarshalErr != nil {
        util.Log("ERROR", "controllers", "TCourierDiscountPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
    ...
    if err != nil {
        util.Log("ERROR", "controllers", "TCourierDiscountPage", "error: "+err.Error())
        res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
        return c.Status(res.Status).JSON(res)
    }
