...
type MEducationLevelHandler struct {
	service  MEducationLevelService
	validate *validator.Validate
}

func NewMEducationLevelHandler(service MEducationLevelService, validate *validator.Validate) *MEducationLevelHandler {
	return &MEducationLevelHandler{
		service:  service,
		validate: validate,
	}
}

// MEducationLevelCreate godoc
//
//	@Summary        MEducationLevelCreate
//	@Description    Create MEducationLevel
//	@Tags           mEducationLevel
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mEducationLevel   body        MEducationLevelRequest    true    "Add MEducationLevelRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-education-level [post]
func (h *MEducationLevelHandler) MEducationLevelCreate(c fiber.Ctx) error {

	res := &response.Response{}
	payload := new(MEducationLevelRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MEducationLevelCreate", "create data error: "+err.Error())
...
// MEducationLevelUpdate godoc
//
//	@Summary        MEducationLevelUpdate
//	@Description    Update MEducationLevel
//	@Tags           mEducationLevel
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mEducationLevel   body        MEducationLevelRequest    true    "Update MEducationLevelRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-education-level [put]
func (h *MEducationLevelHandler) MEducationLevelUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MEducationLevelUpdate", "update data error: "+err.Error())
...
// MEducationLevelIndex godoc
//
//	@Summary        MEducationLevelIndex
//	@Description    Get MEducationLevel by id
//	@Tags           mEducationLevel
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MEducationLevel id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-education-level/{id} [get]
func (h *MEducationLevelHandler) MEducationLevelIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MEducationLevelIndex", err.Error())
...
// MEducationLevelDelete godoc
//
//	@Summary        MEducationLevelDelete
//	@Description    Delete MEducationLevel by id
//	@Tags           mEducationLevel
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-education-level/{id} [delete]
func (h *MEducationLevelHandler) MEducationLevelDelete(c fiber.Ctx) error {
	res := &response.Response{}
...
// MEducationLevelPage godoc
//
//	@Summary        MEducationLevelPage
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-education-level [get]
func (h *MEducationLevelHandler) MEducationLevelPage(c fiber.Ctx) error {
	res := &response.Response{}
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "MEducationLevelPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MEducationLevelPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
