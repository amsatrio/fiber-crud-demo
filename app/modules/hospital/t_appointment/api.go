...
type TAppointmentHandler struct {
	service  TAppointmentService
	validate *validator.Validate
}

func NewTAppointmentHandler(service TAppointmentService, validate *validator.Validate) *TAppointmentHandler {
	return &TAppointmentHandler{
		service:  service,
		validate: validate,
	}
}

// TAppointmentCreate godoc
//
//	@Summary        TAppointmentCreate
//	@Description    Create TAppointment
//	@Tags           tAppointment
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tAppointment   body        TAppointmentRequest    true    "Add TAppointmentRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-appointment [post]
func (h *TAppointmentHandler) TAppointmentCreate(c fiber.Ctx) error {

	res := &response.Response{}
	payload := new(TAppointmentRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TAppointmentCreate", "create data error: "+err.Error())
...
// TAppointmentUpdate godoc
//
//	@Summary        TAppointmentUpdate
//	@Description    Update TAppointment
//	@Tags           tAppointment
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tAppointment   body        TAppointmentRequest    true    "Update TAppointmentRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-appointment [put]
func (h *TAppointmentHandler) TAppointmentUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TAppointmentUpdate", "update data error: "+err.Error())
...
// TAppointmentIndex godoc
//
//	@Summary        TAppointmentIndex
//	@Description    Get TAppointment by id
//	@Tags           tAppointment
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "TAppointment id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-appointment/{id} [get]
func (h *TAppointmentHandler) TAppointmentIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TAppointmentIndex", err.Error())
...
// TAppointmentDelete godoc
//
//	@Summary        TAppointmentDelete
//	@Description    Delete TAppointment by id
//	@Tags           tAppointment
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-appointment/{id} [delete]
func (h *TAppointmentHandler) TAppointmentDelete(c fiber.Ctx) error {
	res := &response.Response{}
...
// TAppointmentPage godoc
//
//	@Summary        TAppointmentPage
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-appointment [get]
func (h *TAppointmentHandler) TAppointmentPage(c fiber.Ctx) error {
	res := &response.Response{}
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "TAppointmentPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TAppointmentPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
