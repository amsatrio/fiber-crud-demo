...
type TCustomerChatHistoryHandler struct {
	service  TCustomerChatHistoryService
	validate *validator.Validate
}

func NewTCustomerChatHistoryHandler(service TCustomerChatHistoryService, validate *validator.Validate) *TCustomerChatHistoryHandler {
	return &TCustomerChatHistoryHandler{
		service:  service,
		validate: validate,
	}
}

// TCustomerChatHistoryCreate godoc
//
//	@Summary        TCustomerChatHistoryCreate
//	@Description    Create TCustomerChatHistory
//	@Tags           tCustomerChatHistory
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tCustomerChatHistory   body        TCustomerChatHistoryRequest    true    "Add TCustomerChatHistoryRequest"
...
func (h *TCustomerChatHistoryHandler) TCustomerChatHistoryCreate(c fiber.Ctx) error {
	...
	payload := new(TCustomerChatHistoryRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCustomerChatHistoryCreate", "create data error: "+err.Error())
...
// TCustomerChatHistoryUpdate godoc
//
//	@Summary        TCustomerChatHistoryUpdate
//	@Description    Update TCustomerChatHistory
//	@Tags           tCustomerChatHistory
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tCustomerChatHistory   body        TCustomerChatHistoryRequest    true    "Update TCustomerChatHistoryRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *TCustomerChatHistoryHandler) TCustomerChatHistoryUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCustomerChatHistoryUpdate", "update data error: "+err.Error())
...
// TCustomerChatHistoryIndex godoc
//
//	@Summary        TCustomerChatHistoryIndex
//	@Description    Get TCustomerChatHistory by id
//	@Tags           tCustomerChatHistory
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "TCustomerChatHistory id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *TCustomerChatHistoryHandler) TCustomerChatHistoryIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCustomerChatHistoryIndex", err.Error())
...
// TCustomerChatHistoryDelete godoc
//
//	@Summary        TCustomerChatHistoryDelete
//	@Description    Delete TCustomerChatHistory by id
//	@Tags           tCustomerChatHistory
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
// TCustomerChatHistoryPage godoc
//
//	@Summary        TCustomerChatHistoryPage
...
func (h *TCustomerChatHistoryHandler) TCustomerChatHistoryPage(c fiber.Ctx) error {
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "TCustomerChatHistoryPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCustomerChatHistoryPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
