...
func NewMRoleHandler(service MRoleService, validate *validator.Validate) *MRoleHandler {
	return &MRoleHandler{
		service:  service,
		validate: validate,
	}
...
//	@Param          mRole   body        MRoleRequest    true    "Add MRoleRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-role [post]
func (h *MRoleHandler) MRoleCreate(c fiber.Ctx) error {

	res := &response.Response{}
	payload := new(MRoleRequest)
...
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mRole   body        MRoleRequest    true    "Update MRoleRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-role [put]
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-role/{id} [get]
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-role/{id} [delete]
