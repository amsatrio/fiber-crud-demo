...
type TDoctorTreatmentHandler struct {
	service  TDoctorTreatmentService
	validate *validator.Validate
}

func NewTDoctorTreatmentHandler(service TDoctorTreatmentService, validate *validator.Validate) *TDoctorTreatmentHandler {
	return &TDoctorTreatmentHandler{
		service:  service,
		validate: validate,
	}
}

// TDoctorTreatmentCreate godoc
//
//	@Summary        TDoctorTreatmentCreate
//	@Description    Create TDoctorTreatment
//	@Tags           tDoctorTreatment
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tDoctorTreatment   body        TDoctorTreatmentRequest    true    "Add TDoctorTreatmentRequest"
...
func (h *TDoctorTreatmentHandler) TDoctorTreatmentCreate(c fiber.Ctx) error {
	...
	payload := new(TDoctorTreatmentRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TDoctorTreatmentCreate", "create data error: "+err.Error())
...
// TDoctorTreatmentUpdate godoc
//
//	@Summary        TDoctorTreatmentUpdate
//	@Description    Update TDoctorTreatment
//	@Tags           tDoctorTreatment
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tDoctorTreatment   body        TDoctorTreatmentRequest    true    "Update TDoctorTreatmentRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *TDoctorTreatmentHandler) TDoctorTreatmentUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TDoctorTreatmentUpdate", "update data error: "+err.Error())
...
// TDoctorTreatmentIndex godoc
//
//	@Summary        TDoctorTreatmentIndex
//	@Description    Get TDoctorTreatment by id
//	@Tags           tDoctorTreatment
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "TDoctorTreatment id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *TDoctorTreatmentHandler) TDoctorTreatmentIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TDoctorTreatmentIndex", err.Error())
...
// TDoctorTreatmentDelete godoc
//
//	@Summary        TDoctorTreatmentDelete
//	@Description    Delete TDoctorTreatment by id
//	@Tags           tDoctorTreatment
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
// TDoctorTreatmentPage godoc
//
//	@Summary        TDoctorTreatmentPage
...
func (h *TDoctorTreatmentHandler) TDoctorTreatmentPage(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TDoctorTreatmentPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
