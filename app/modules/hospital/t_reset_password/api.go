...
type TResetPasswordHandler struct {
	service  TResetPasswordService
	validate *validator.Validate
}

func NewTResetPasswordHandler(service TResetPasswordService, validate *validator.Validate) *TResetPasswordHandler {
	return &TResetPasswordHandler{
		service:  service,
		validate: validate,
	}
}
...
//	@Param          tResetPassword   body        TResetPasswordRequest    true    "Add TResetPasswordRequest"
...
func (h *TResetPasswordHandler) TResetPasswordCreate(c fiber.Ctx) error {
	...
	payload := new(TResetPasswordRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TResetPasswordCreate", "create data error: "+err.Error())
...
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tResetPassword   body        TResetPasswordRequest    true    "Update TResetPasswordRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *TResetPasswordHandler) TResetPasswordUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TResetPasswordUpdate", "update data error: "+err.Error())
