...
type TCustomerVaHistoryHandler struct {
	service  TCustomerVaHistoryService
	validate *validator.Validate
}

func NewTCustomerVaHistoryHandler(service TCustomerVaHistoryService, validate *validator.Validate) *TCustomerVaHistoryHandler {
	return &TCustomerVaHistoryHandler{
		service:  service,
		validate: validate,
	}
}

// TCustomerVaHistoryCreate godoc
//
//	@Summary        TCustomerVaHistoryCreate
//	@Description    Create TCustomerVaHistory
//	@Tags           tCustomerVaHistory
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tCustomerVaHistory   body        TCustomerVaHistoryRequest    true    "Add TCustomerVaHistoryRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-customer-va-history [post]
func (h *TCustomerVaHistoryHandler) TCustomerVaHistoryCreate(c fiber.Ctx) error {

	res := &response.Response{}
	payload := new(TCustomerVaHistoryRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCustomerVaHistoryCreate", "create data error: "+err.Error())
...
// TCustomerVaHistoryUpdate godoc
//
//	@Summary        TCustomerVaHistoryUpdate
//	@Description    Update TCustomerVaHistory
//	@Tags           tCustomerVaHistory
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tCustomerVaHistory   body        TCustomerVaHistoryRequest    true    "Update TCustomerVaHistoryRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-customer-va-history [put]
func (h *TCustomerVaHistoryHandler) TCustomerVaHistoryUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCustomerVaHistoryUpdate", "update data error: "+err.Error())
...
// TCustomerVaHistoryIndex godoc
//
//	@Summary        TCustomerVaHistoryIndex
//	@Description    Get TCustomerVaHistory by id
//	@Tags           tCustomerVaHistory
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "TCustomerVaHistory id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-customer-va-history/{id} [get]
func (h *TCustomerVaHistoryHandler) TCustomerVaHistoryIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCustomerVaHistoryIndex", err.Error())
...
// TCustomerVaHistoryDelete godoc
//
//	@Summary        TCustomerVaHistoryDelete
//	@Description    Delete TCustomerVaHistory by id
//	@Tags           tCustomerVaHistory
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-customer-va-history/{id} [delete]
func (h *TCustomerVaHistoryHandler) TCustomerVaHistoryDelete(c fiber.Ctx) error {
	res := &response.Response{}
...
// TCustomerVaHistoryPage godoc
//
//	@Summary        TCustomerVaHistoryPage
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-customer-va-history [get]
func (h *TCustomerVaHistoryHandler) TCustomerVaHistoryPage(c fiber.Ctx) error {
	res := &response.Response{}
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "TCustomerVaHistoryPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCustomerVaHistoryPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
