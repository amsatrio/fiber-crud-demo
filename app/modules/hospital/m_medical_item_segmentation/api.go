...
type MMedicalItemSegmentationHandler struct {
	service  MMedicalItemSegmentationService
	validate *validator.Validate
}

func NewMMedicalItemSegmentationHandler(service MMedicalItemSegmentationService, validate *validator.Validate) *MMedicalItemSegmentationHandler {
	return &MMedicalItemSegmentationHandler{
		service:  service,
		validate: validate,
	}
}

// MMedicalItemSegmentationCreate godoc
//
//	@Summary        MMedicalItemSegmentationCreate
//	@Description    Create MMedicalItemSegmentation
//	@Tags           mMedicalItemSegmentation
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mMedicalItemSegmentation   body        MMedicalItemSegmentationRequest    true    "Add MMedicalItemSegmentationRequest"
...
func (h *MMedicalItemSegmentationHandler) MMedicalItemSegmentationCreate(c fiber.Ctx) error {
	...
	payload := new(MMedicalItemSegmentationRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMedicalItemSegmentationCreate", "create data error: "+err.Error())
...
// MMedicalItemSegmentationUpdate godoc
//
//	@Summary        MMedicalItemSegmentationUpdate
//	@Description    Update MMedicalItemSegmentation
//	@Tags           mMedicalItemSegmentation
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mMedicalItemSegmentation   body        MMedicalItemSegmentationRequest    true    "Update MMedicalItemSegmentationRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *MMedicalItemSegmentationHandler) MMedicalItemSegmentationUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMedicalItemSegmentationUpdate", "update data error: "+err.Error())
...
// MMedicalItemSegmentationIndex godoc
//
//	@Summary        MMedicalItemSegmentationIndex
//	@Description    Get MMedicalItemSegmentation by id
//	@Tags           mMedicalItemSegmentation
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MMedicalItemSegmentation id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *MMedicalItemSegmentationHandler) MMedicalItemSegmentationIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMedicalItemSegmentationIndex", err.Error())
...
// MMedicalItemSegmentationDelete godoc
//
//	@Summary        MMedicalItemSegmentationDelete
//	@Description    Delete MMedicalItemSegmentation by id
//	@Tags           mMedicalItemSegmentation
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
// MMedicalItemSegmentationPage godoc
//
//	@Summary        MMedicalItemSegmentationPage
...
func (h *MMedicalItemSegmentationHandler) MMedicalItemSegmentationPage(c fiber.Ctx) error {
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "MMedicalItemSegmentationPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMedicalItemSegmentationPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
