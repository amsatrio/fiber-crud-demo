...
type TAppointmentDoneHandler struct {
	service  TAppointmentDoneService
	validate *validator.Validate
}

func NewTAppointmentDoneHandler(service TAppointmentDoneService, validate *validator.Validate) *TAppointmentDoneHandler {
	return &TAppointmentDoneHandler{
		service:  service,
		validate: validate,
	}
}

// TAppointmentDoneCreate godoc
//
//	@Summary        TAppointmentDoneCreate
//	@Description    Create TAppointmentDone
//	@Tags           tAppointmentDone
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tAppointmentDone   body        TAppointmentDoneRequest    true    "Add TAppointmentDoneRequest"
...
func (h *TAppointmentDoneHandler) TAppointmentDoneCreate(c fiber.Ctx) error {
	...
	payload := new(TAppointmentDoneRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TAppointmentDoneCreate", "create data error: "+err.Error())
...
// TAppointmentDoneUpdate godoc
//
//	@Summary        TAppointmentDoneUpdate
//	@Description    Update TAppointmentDone
//	@Tags           tAppointmentDone
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tAppointmentDone   body        TAppointmentDoneRequest    true    "Update TAppointmentDoneRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *TAppointmentDoneHandler) TAppointmentDoneUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TAppointmentDoneUpdate", "update data error: "+err.Error())
...
// TAppointmentDoneIndex godoc
//
//	@Summary        TAppointmentDoneIndex
//	@Description    Get TAppointmentDone by id
//	@Tags           tAppointmentDone
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "TAppointmentDone id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *TAppointmentDoneHandler) TAppointmentDoneIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TAppointmentDoneIndex", err.Error())
...
// TAppointmentDoneDelete godoc
//
//	@Summary        TAppointmentDoneDelete
//	@Description    Delete TAppointmentDone by id
//	@Tags           tAppointmentDone
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
// TAppointmentDonePage godoc
//
//	@Summary        TAppointmentDonePage
...
func (h *TAppointmentDoneHandler) TAppointmentDonePage(c fiber.Ctx) error {
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "TAppointmentDonePage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TAppointmentDonePage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
