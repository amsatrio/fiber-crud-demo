...
type MDoctorHandler struct {
	service  MDoctorService
	validate *validator.Validate
}

func NewMDoctorHandler(service MDoctorService, validate *validator.Validate) *MDoctorHandler {
	return &MDoctorHandler{
		service:  service,
		validate: validate,
	}
}
...
// MDoctorCreate godoc
//
//	@Summary        MDoctorCreate
//	@Description    Create MDoctor
//	@Tags           mDoctor
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mDoctor   body        MDoctorRequest    true    "Add MDoctorRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-doctor [post]
func (h *MDoctorHandler) MDoctorCreate(c fiber.Ctx) error {

	res := &response.Response{}
	payload := new(MDoctorRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MDoctorCreate", "create data error: "+err.Error())
...
// MDoctorUpdate godoc
//
//	@Summary        MDoctorUpdate
//	@Description    Update MDoctor
//	@Tags           mDoctor
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mDoctor   body        MDoctorRequest    true    "Update MDoctorRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-doctor [put]
func (h *MDoctorHandler) MDoctorUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MDoctorUpdate", "update data error: "+err.Error())
...
// MDoctorIndex godoc
//
//	@Summary        MDoctorIndex
//	@Description    Get MDoctor by id
//	@Tags           mDoctor
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MDoctor id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-doctor/{id} [get]
func (h *MDoctorHandler) MDoctorIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MDoctorIndex", err.Error())
...
// MDoctorDelete godoc
//
//	@Summary        MDoctorDelete
//	@Description    Delete MDoctor by id
//	@Tags           mDoctor
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-doctor/{id} [delete]
func (h *MDoctorHandler) MDoctorDelete(c fiber.Ctx) error {
	res := &response.Response{}
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-doctor [get]
func (h *MDoctorHandler) MDoctorPage(c fiber.Ctx) error {
	res := &response.Response{}
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "MDoctorPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MDoctorPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
