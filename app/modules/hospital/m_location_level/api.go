...
type MLocationLevelHandler struct {
	service  MLocationLevelService
	validate *validator.Validate
}

func NewMLocationLevelHandler(service MLocationLevelService, validate *validator.Validate) *MLocationLevelHandler {
	return &MLocationLevelHandler{
		service:  service,
		validate: validate,
	}
}

// MLocationLevelCreate godoc
//
//	@Summary        MLocationLevelCreate
//	@Description    Create MLocationLevel
//	@Tags           mLocationLevel
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mLocationLevel   body        MLocationLevelRequest    true    "Add MLocationLevelRequest"
...
func (h *MLocationLevelHandler) MLocationLevelCreate(c fiber.Ctx) error {
	...
	payload := new(MLocationLevelRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MLocationLevelCreate", "create data error: "+err.Error())
...
// MLocationLevelUpdate godoc
//
//	@Summary        MLocationLevelUpdate
//	@Description    Update MLocationLevel
//	@Tags           mLocationLevel
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mLocationLevel   body        MLocationLevelRequest    true    "Update MLocationLevelRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *MLocationLevelHandler) MLocationLevelUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MLocationLevelUpdate", "update data error: "+err.Error())
...
// MLocationLevelIndex godoc
//
//	@Summary        MLocationLevelIndex
//	@Description    Get MLocationLevel by id
//	@Tags           mLocationLevel
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MLocationLevel id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *MLocationLevelHandler) MLocationLevelIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MLocationLevelIndex", err.Error())
...
// MLocationLevelDelete godoc
//
//	@Summary        MLocationLevelDelete
//	@Description    Delete MLocationLevel by id
//	@Tags           mLocationLevel
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
// MLocationLevelPage godoc
//
//	@Summary        MLocationLevelPage
...
func (h *MLocationLevelHandler) MLocationLevelPage(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MLocationLevelPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
