...
type TCurrentDoctorSpecializationHandler struct {
	service  TCurrentDoctorSpecializationService
	validate *validator.Validate
}

func NewTCurrentDoctorSpecializationHandler(service TCurrentDoctorSpecializationService, validate *validator.Validate) *TCurrentDoctorSpecializationHandler {
	return &TCurrentDoctorSpecializationHandler{
		service:  service,
		validate: validate,
	}
}

// TCurrentDoctorSpecializationCreate godoc
//
//	@Summary        TCurrentDoctorSpecializationCreate
//	@Description    Create TCurrentDoctorSpecialization
//	@Tags           tCurrentDoctorSpecialization
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tCurrentDoctorSpecialization   body        TCurrentDoctorSpecializationRequest    true    "Add TCurrentDoctorSpecializationRequest"
...
func (h *TCurrentDoctorSpecializationHandler) TCurrentDoctorSpecializationCreate(c fiber.Ctx) error {
	...
	payload := new(TCurrentDoctorSpecializationRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCurrentDoctorSpecializationCreate", "create data error: "+err.Error())
...
// TCurrentDoctorSpecializationUpdate godoc
//
//	@Summary        TCurrentDoctorSpecializationUpdate
//	@Description    Update TCurrentDoctorSpecialization
//	@Tags           tCurrentDoctorSpecialization
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tCurrentDoctorSpecialization   body        TCurrentDoctorSpecializationRequest    true    "Update TCurrentDoctorSpecializationRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *TCurrentDoctorSpecializationHandler) TCurrentDoctorSpecializationUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCurrentDoctorSpecializationUpdate", "update data error: "+err.Error())
...
// TCurrentDoctorSpecializationIndex godoc
//
//	@Summary        TCurrentDoctorSpecializationIndex
//	@Description    Get TCurrentDoctorSpecialization by id
//	@Tags           tCurrentDoctorSpecialization
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "TCurrentDoctorSpecialization id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *TCurrentDoctorSpecializationHandler) TCurrentDoctorSpecializationIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCurrentDoctorSpecializationIndex", err.Error())
...
// TCurrentDoctorSpecializationDelete godoc
//
//	@Summary        TCurrentDoctorSpecializationDelete
//	@Description    Delete TCurrentDoctorSpecialization by id
//	@Tags           tCurrentDoctorSpecialization
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
// TCurrentDoctorSpecializationPage godoc
//
//	@Summary        TCurrentDoctorSpecializationPage
...
func (h *TCurrentDoctorSpecializationHandler) TCurrentDoctorSpecializationPage(c fiber.Ctx) error {
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "TCurrentDoctorSpecializationPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCurrentDoctorSpecializationPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
