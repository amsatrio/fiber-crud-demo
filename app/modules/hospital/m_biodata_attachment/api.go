...
type MBiodataAttachmentHandler struct {
	service  MBiodataAttachmentService
	validate *validator.Validate
}

func NewMBiodataAttachmentHandler(service MBiodataAttachmentService, validate *validator.Validate) *MBiodataAttachmentHandler {
	return &MBiodataAttachmentHandler{
		service:  service,
		validate: validate,
	}
}

// MBiodataAttachmentCreate godoc
//
//	@Summary        MBiodataAttachmentCreate
//	@Description    Create MBiodataAttachment
//	@Tags           mBiodataAttachment
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mBiodataAttachment   body        MBiodataAttachmentRequest    true    "Add MBiodataAttachmentRequest"
...
func (h *MBiodataAttachmentHandler) MBiodataAttachmentCreate(c fiber.Ctx) error {
	...
	payload := new(MBiodataAttachmentRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MBiodataAttachmentCreate", "create data error: "+err.Error())
...
// MBiodataAttachmentUpdate godoc
//
//	@Summary        MBiodataAttachmentUpdate
//	@Description    Update MBiodataAttachment
//	@Tags           mBiodataAttachment
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mBiodataAttachment   body        MBiodataAttachmentRequest    true    "Update MBiodataAttachmentRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *MBiodataAttachmentHandler) MBiodataAttachmentUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MBiodataAttachmentUpdate", "update data error: "+err.Error())
...
// MBiodataAttachmentIndex godoc
//
//	@Summary        MBiodataAttachmentIndex
//	@Description    Get MBiodataAttachment by id
//	@Tags           mBiodataAttachment
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MBiodataAttachment id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *MBiodataAttachmentHandler) MBiodataAttachmentIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MBiodataAttachmentIndex", err.Error())
...
// MBiodataAttachmentDelete godoc
//
//	@Summary        MBiodataAttachmentDelete
//	@Description    Delete MBiodataAttachment by id
//	@Tags           mBiodataAttachment
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
// MBiodataAttachmentPage godoc
//
//	@Summary        MBiodataAttachmentPage
...
func (h *MBiodataAttachmentHandler) MBiodataAttachmentPage(c fiber.Ctx) error {
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "MBiodataAttachmentPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MBiodataAttachmentPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
