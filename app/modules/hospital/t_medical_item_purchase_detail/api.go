...
type TMedicalItemPurchaseDetailHandler struct {
	service  TMedicalItemPurchaseDetailService
	validate *validator.Validate
}

func NewTMedicalItemPurchaseDetailHandler(service TMedicalItemPurchaseDetailService, validate *validator.Validate) *TMedicalItemPurchaseDetailHandler {
	return &TMedicalItemPurchaseDetailHandler{
		service:  service,
		validate: validate,
	}
}

// TMedicalItemPurchaseDetailCreate godoc
//
//	@Summary        TMedicalItemPurchaseDetailCreate
//	@Description    Create TMedicalItemPurchaseDetail
//	@Tags           tMedicalItemPurchaseDetail
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tMedicalItemPurchaseDetail   body        TMedicalItemPurchaseDetailRequest    true    "Add TMedicalItemPurchaseDetailRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-medical-item-purchase-detail [post]
func (h *TMedicalItemPurchaseDetailHandler) TMedicalItemPurchaseDetailCreate(c fiber.Ctx) error {

	res := &response.Response{}
	payload := new(TMedicalItemPurchaseDetailRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TMedicalItemPurchaseDetailCreate", "create data error: "+err.Error())
...
// TMedicalItemPurchaseDetailUpdate godoc
//
//	@Summary        TMedicalItemPurchaseDetailUpdate
//	@Description    Update TMedicalItemPurchaseDetail
//	@Tags           tMedicalItemPurchaseDetail
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tMedicalItemPurchaseDetail   body        TMedicalItemPurchaseDetailRequest    true    "Update TMedicalItemPurchaseDetailRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-medical-item-purchase-detail [put]
func (h *TMedicalItemPurchaseDetailHandler) TMedicalItemPurchaseDetailUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TMedicalItemPurchaseDetailUpdate", "update data error: "+err.Error())
...
// TMedicalItemPurchaseDetailIndex godoc
//
//	@Summary        TMedicalItemPurchaseDetailIndex
//	@Description    Get TMedicalItemPurchaseDetail by id
//	@Tags           tMedicalItemPurchaseDetail
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "TMedicalItemPurchaseDetail id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-medical-item-purchase-detail/{id} [get]
func (h *TMedicalItemPurchaseDetailHandler) TMedicalItemPurchaseDetailIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TMedicalItemPurchaseDetailIndex", err.Error())
...
// TMedicalItemPurchaseDetailDelete godoc
//
//	@Summary        TMedicalItemPurchaseDetailDelete
//	@Description    Delete TMedicalItemPurchaseDetail by id
//	@Tags           tMedicalItemPurchaseDetail
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-medical-item-purchase-detail/{id} [delete]
func (h *TMedicalItemPurchaseDetailHandler) TMedicalItemPurchaseDetailDelete(c fiber.Ctx) error {
	res := &response.Response{}
...
// TMedicalItemPurchaseDetailPage godoc
//
//	@Summary        TMedicalItemPurchaseDetailPage
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-medical-item-purchase-detail [get]
func (h *TMedicalItemPurchaseDetailHandler) TMedicalItemPurchaseDetailPage(c fiber.Ctx) error {
	res := &response.Response{}
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "TMedicalItemPurchaseDetailPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TMedicalItemPurchaseDetailPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
