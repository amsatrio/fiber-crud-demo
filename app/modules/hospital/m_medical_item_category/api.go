...
type MMedicalItemCategoryHandler struct {
	service  MMedicalItemCategoryService
	validate *validator.Validate
}

func NewMMedicalItemCategoryHandler(service MMedicalItemCategoryService, validate *validator.Validate) *MMedicalItemCategoryHandler {
	return &MMedicalItemCategoryHandler{
		service:  service,
		validate: validate,
	}
}

// MMedicalItemCategoryCreate godoc
//
//	@Summary        MMedicalItemCategoryCreate
//	@Description    Create MMedicalItemCategory
//	@Tags           mMedicalItemCategory
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mMedicalItemCategory   body        MMedicalItemCategoryRequest    true    "Add MMedicalItemCategoryRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-medical-item-category [post]
func (h *MMedicalItemCategoryHandler) MMedicalItemCategoryCreate(c fiber.Ctx) error {

	res := &response.Response{}
	payload := new(MMedicalItemCategoryRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMedicalItemCategoryCreate", "create data error: "+err.Error())
...
// MMedicalItemCategoryUpdate godoc
//
//	@Summary        MMedicalItemCategoryUpdate
//	@Description    Update MMedicalItemCategory
//	@Tags           mMedicalItemCategory
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mMedicalItemCategory   body        MMedicalItemCategoryRequest    true    "Update MMedicalItemCategoryRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-medical-item-category [put]
func (h *MMedicalItemCategoryHandler) MMedicalItemCategoryUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMedicalItemCategoryUpdate", "update data error: "+err.Error())
...
// MMedicalItemCategoryIndex godoc
//
//	@Summary        MMedicalItemCategoryIndex
//	@Description    Get MMedicalItemCategory by id
//	@Tags           mMedicalItemCategory
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MMedicalItemCategory id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-medical-item-category/{id} [get]
func (h *MMedicalItemCategoryHandler) MMedicalItemCategoryIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMedicalItemCategoryIndex", err.Error())
...
// MMedicalItemCategoryDelete godoc
//
//	@Summary        MMedicalItemCategoryDelete
//	@Description    Delete MMedicalItemCategory by id
//	@Tags           mMedicalItemCategory
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-medical-item-category/{id} [delete]
func (h *MMedicalItemCategoryHandler) MMedicalItemCategoryDelete(c fiber.Ctx) error {
	res := &response.Response{}
...
// MMedicalItemCategoryPage godoc
//
//	@Summary        MMedicalItemCategoryPage
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-medical-item-category [get]
func (h *MMedicalItemCategoryHandler) MMedicalItemCategoryPage(c fiber.Ctx) error {
	res := &response.Response{}
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "MMedicalItemCategoryPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMedicalItemCategoryPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
