...
type MBloodGroupHandler struct {
	service  MBloodGroupService
	validate *validator.Validate
}

func NewMBloodGroupHandler(service MBloodGroupService, validate *validator.Validate) *MBloodGroupHandler {
	return &MBloodGroupHandler{
		service:  service,
		validate: validate,
	}
}

// MBloodGroupCreate godoc
//
//	@Summary        MBloodGroupCreate
//	@Description    Create MBloodGroup
//	@Tags           mBloodGroup
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mBloodGroup   body        MBloodGroupRequest    true    "Add MBloodGroupRequest"
...
func (h *MBloodGroupHandler) MBloodGroupCreate(c fiber.Ctx) error {
	...
	payload := new(MBloodGroupRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MBloodGroupCreate", "create data error: "+err.Error())
...
// MBloodGroupUpdate godoc
//
//	@Summary        MBloodGroupUpdate
//	@Description    Update MBloodGroup
//	@Tags           mBloodGroup
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mBloodGroup   body        MBloodGroupRequest    true    "Update MBloodGroupRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *MBloodGroupHandler) MBloodGroupUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MBloodGroupUpdate", "update data error: "+err.Error())
...
// MBloodGroupIndex godoc
//
//	@Summary        MBloodGroupIndex
//	@Description    Get MBloodGroup by id
//	@Tags           mBloodGroup
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MBloodGroup id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *MBloodGroupHandler) MBloodGroupIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MBloodGroupIndex", err.Error())
...
// MBloodGroupDelete godoc
//
//	@Summary        MBloodGroupDelete
//	@Description    Delete MBloodGroup by id
//	@Tags           mBloodGroup
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
// MBloodGroupPage godoc
//
//	@Summary        MBloodGroupPage
...
func (h *MBloodGroupHandler) MBloodGroupPage(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MBloodGroupPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
