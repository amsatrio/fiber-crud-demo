...
type MMedicalItemHandler struct {
	service  MMedicalItemService
	validate *validator.Validate
}

func NewMMedicalItemHandler(service MMedicalItemService, validate *validator.Validate) *MMedicalItemHandler {
	return &MMedicalItemHandler{
		service:  service,
		validate: validate,
	}
}

// MMedicalItemCreate godoc
//
//	@Summary        MMedicalItemCreate
//	@Description    Create MMedicalItem
//	@Tags           mMedicalItem
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mMedicalItem   body        MMedicalItemRequest    true    "Add MMedicalItemRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-medical-item [post]
func (h *MMedicalItemHandler) MMedicalItemCreate(c fiber.Ctx) error {

	res := &response.Response{}
	payload := new(MMedicalItemRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMedicalItemCreate", "create data error: "+err.Error())
...
// MMedicalItemUpdate godoc
//
//	@Summary        MMedicalItemUpdate
//	@Description    Update MMedicalItem
//	@Tags           mMedicalItem
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mMedicalItem   body        MMedicalItemRequest    true    "Update MMedicalItemRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-medical-item [put]
func (h *MMedicalItemHandler) MMedicalItemUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMedicalItemUpdate", "update data error: "+err.Error())
...
// MMedicalItemIndex godoc
//
//	@Summary        MMedicalItemIndex
//	@Description    Get MMedicalItem by id
//	@Tags           mMedicalItem
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MMedicalItem id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-medical-item/{id} [get]
func (h *MMedicalItemHandler) MMedicalItemIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMedicalItemIndex", err.Error())
...
// MMedicalItemDelete godoc
//
//	@Summary        MMedicalItemDelete
//	@Description    Delete MMedicalItem by id
//	@Tags           mMedicalItem
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-medical-item/{id} [delete]
func (h *MMedicalItemHandler) MMedicalItemDelete(c fiber.Ctx) error {
	res := &response.Response{}
...
// MMedicalItemPage godoc
//
//	@Summary        MMedicalItemPage
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-medical-item [get]
func (h *MMedicalItemHandler) MMedicalItemPage(c fiber.Ctx) error {
	res := &response.Response{}
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "MMedicalItemPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MMedicalItemPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
