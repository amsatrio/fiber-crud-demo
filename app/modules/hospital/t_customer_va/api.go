...
type TCustomerVaHandler struct {
	service  TCustomerVaService
	validate *validator.Validate
}

func NewTCustomerVaHandler(service TCustomerVaService, validate *validator.Validate) *TCustomerVaHandler {
	return &TCustomerVaHandler{
		service:  service,
		validate: validate,
	}
}

// TCustomerVaCreate godoc
//
//	@Summary        TCustomerVaCreate
//	@Description    Create TCustomerVa
//	@Tags           tCustomerVa
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tCustomerVa   body        TCustomerVaRequest    true    "Add TCustomerVaRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-customer-va [post]
func (h *TCustomerVaHandler) TCustomerVaCreate(c fiber.Ctx) error {

	res := &response.Response{}
	payload := new(TCustomerVaRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCustomerVaCreate", "create data error: "+err.Error())
...
// TCustomerVaUpdate godoc
//
//	@Summary        TCustomerVaUpdate
//	@Description    Update TCustomerVa
//	@Tags           tCustomerVa
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          tCustomerVa   body        TCustomerVaRequest    true    "Update TCustomerVaRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-customer-va [put]
func (h *TCustomerVaHandler) TCustomerVaUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCustomerVaUpdate", "update data error: "+err.Error())
...
// TCustomerVaIndex godoc
//
//	@Summary        TCustomerVaIndex
//	@Description    Get TCustomerVa by id
//	@Tags           tCustomerVa
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "TCustomerVa id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-customer-va/{id} [get]
func (h *TCustomerVaHandler) TCustomerVaIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCustomerVaIndex", err.Error())
...
// TCustomerVaDelete godoc
//
//	@Summary        TCustomerVaDelete
//	@Description    Delete TCustomerVa by id
//	@Tags           tCustomerVa
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-customer-va/{id} [delete]
func (h *TCustomerVaHandler) TCustomerVaDelete(c fiber.Ctx) error {
	res := &response.Response{}
...
// TCustomerVaPage godoc
//
//	@Summary        TCustomerVaPage
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/t-customer-va [get]
func (h *TCustomerVaHandler) TCustomerVaPage(c fiber.Ctx) error {
	res := &response.Response{}
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "TCustomerVaPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "TCustomerVaPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
