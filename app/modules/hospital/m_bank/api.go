...
type MBankHandler struct {
	service  MBankService
	validate *validator.Validate
}

func NewMBankHandler(service MBankService, validate *validator.Validate) *MBankHandler {
	return &MBankHandler{
		service:  service,
		validate: validate,
	}
...
//
//	@Summary        MBankCreate
//	@Description    Create MBank
//	@Tags           mBank
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mBank   body        MBankRequest    true    "Add MBankRequest"
...
func (h *MBankHandler) MBankCreate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MBankCreate", "create data error: "+err.Error())
...
//
//	@Summary        MBankUpdate
//	@Description    Update MBank
//	@Tags           mBank
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mBank   body        MBankRequest    true    "Update MBankRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *MBankHandler) MBankUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MBankUpdate", "update data error: "+err.Error())
...
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MBank id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
...
func (h *MBankHandler) MBankIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MBankIndex", err.Error())
...
//
//	@Summary        MBankDelete
//	@Description    Delete MBank by id
//	@Tags           mBank
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
func (h *MBankHandler) MBankPage(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MBankPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
