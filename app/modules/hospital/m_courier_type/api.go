...
type MCourierTypeHandler struct {
	service  MCourierTypeService
	validate *validator.Validate
}

func NewMCourierTypeHandler(service MCourierTypeService, validate *validator.Validate) *MCourierTypeHandler {
	return &MCourierTypeHandler{
		service:  service,
		validate: validate,
	}
}

// MCourierTypeCreate godoc
//
//	@Summary        MCourierTypeCreate
//	@Description    Create MCourierType
//	@Tags           mCourierType
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mCourierType   body        MCourierTypeRequest    true    "Add MCourierTypeRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-courier-type [post]
func (h *MCourierTypeHandler) MCourierTypeCreate(c fiber.Ctx) error {

	res := &response.Response{}
	payload := new(MCourierTypeRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MCourierTypeCreate", "create data error: "+err.Error())
...
// MCourierTypeUpdate godoc
//
//	@Summary        MCourierTypeUpdate
//	@Description    Update MCourierType
//	@Tags           mCourierType
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mCourierType   body        MCourierTypeRequest    true    "Update MCourierTypeRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-courier-type [put]
func (h *MCourierTypeHandler) MCourierTypeUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MCourierTypeUpdate", "update data error: "+err.Error())
...
// MCourierTypeIndex godoc
//
//	@Summary        MCourierTypeIndex
//	@Description    Get MCourierType by id
//	@Tags           mCourierType
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MCourierType id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-courier-type/{id} [get]
func (h *MCourierTypeHandler) MCourierTypeIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MCourierTypeIndex", err.Error())
...
// MCourierTypeDelete godoc
//
//	@Summary        MCourierTypeDelete
//	@Description    Delete MCourierType by id
//	@Tags           mCourierType
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-courier-type/{id} [delete]
func (h *MCourierTypeHandler) MCourierTypeDelete(c fiber.Ctx) error {
	res := &response.Response{}
...
// MCourierTypePage godoc
//
//	@Summary        MCourierTypePage
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-courier-type [get]
func (h *MCourierTypeHandler) MCourierTypePage(c fiber.Ctx) error {
	res := &response.Response{}
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "MCourierTypePage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MCourierTypePage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
