...
type MCustomerHandler struct {
	service  MCustomerService
	validate *validator.Validate
}

func NewMCustomerHandler(service MCustomerService, validate *validator.Validate) *MCustomerHandler {
	return &MCustomerHandler{
		service:  service,
		validate: validate,
	}
}

// MCustomerCreate godoc
//
//	@Summary        MCustomerCreate
//	@Description    Create MCustomer
//	@Tags           mCustomer
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mCustomer   body        MCustomerRequest    true    "Add MCustomerRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-customer [post]
func (h *MCustomerHandler) MCustomerCreate(c fiber.Ctx) error {

	res := &response.Response{}
	payload := new(MCustomerRequest)
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MCustomerCreate", "create data error: "+err.Error())
...
// MCustomerUpdate godoc
//
//	@Summary        MCustomerUpdate
//	@Description    Update MCustomer
//	@Tags           mCustomer
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          mCustomer   body        MCustomerRequest    true    "Update MCustomerRequest"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-customer [put]
func (h *MCustomerHandler) MCustomerUpdate(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MCustomerUpdate", "update data error: "+err.Error())
...
// MCustomerIndex godoc
//
//	@Summary        MCustomerIndex
//	@Description    Get MCustomer by id
//	@Tags           mCustomer
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
//	@Param          id  path        int true    "MCustomer id"
//	@Success        200 {object}    response.Response
//	@Failure        400 {object}    response.Response
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-customer/{id} [get]
func (h *MCustomerHandler) MCustomerIndex(c fiber.Ctx) error {
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MCustomerIndex", err.Error())
...
// MCustomerDelete godoc
//
//	@Summary        MCustomerDelete
//	@Description    Delete MCustomer by id
//	@Tags           mCustomer
//	@Accept         json
//	@Produce        json
//	@Param          Accept-Encoding header  string  false   "gzip" default(gzip)
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-customer/{id} [delete]
func (h *MCustomerHandler) MCustomerDelete(c fiber.Ctx) error {
	res := &response.Response{}
...
//	@Failure        404 {object}    response.Response
//	@Failure        500 {object}    response.Response
//	@Router         /v1/hospital/m-customer [get]
func (h *MCustomerHandler) MCustomerPage(c fiber.Ctx) error {
	res := &response.Response{}
	...
	if jsonUnmarshalErr != nil {
		util.Log("ERROR", "controllers", "MCustomerPage", "jsonUnmarshalErr error: "+jsonUnmarshalErr.Error())
	...
	if err != nil {
		util.Log("ERROR", "controllers", "MCustomerPage", "error: "+err.Error())
		res.ErrMessage(c.Path(), fiber.StatusBadRequest, "get data error: "+err.Error())
		return c.Status(res.Status).JSON(res)
	}
